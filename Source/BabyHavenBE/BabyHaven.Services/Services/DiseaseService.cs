    ...
    public class DiseaseService : IDiseaseService
    {
        ...
        public async Task<IServiceResult> Create(DiseaseCreateDto diseaseCreateDto)
        {
            try
            {
                ...
                // Map DTO to entity
                var disease = diseaseCreateDto.MapToDiseaseCreateEntity(); 

                var result = await _unitOfWork.DiseaseRepository
                    .CreateAsync(disease);
